                  ...
                  <AccordionItem key={data._id} >
                    ...
                    <AccordionPanel className="journal-panel" pb={4}>
                      ...
                      <div className="button-cnt">
                        <Button style={{ marginTop: "15px", width: "100px" }} colorScheme='orange' onClick={onDelete} id={data._id}>
                          Delete
                        </Button>
                        <Button
