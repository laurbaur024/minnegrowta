                  ...
                  <CardBody>
                    <Stack divider={<StackDivider />} spacing="3">
                      ...
                      <Box>
                        <UnorderedList>
                          <ListItem>
                            <span key={plant.type} style={bold}>
                              Type:{" "}
                            </span>
                            {plant.type}
                          </ListItem>
                          <ListItem>
                            <span key={plant.sowSpace} style={bold}>
                              Sow Space:{" "}
                            </span>
                            {plant.sowSpace}
                          </ListItem>
                          <ListItem>
                            <span key={plant.sun} style={bold}>
                              Sun:{" "}
                            </span>
                            {plant.sun}
                          </ListItem>
                          <ListItem>
                            <span key={plant.zone} style={bold}>
                              Grow Zone:{" "}
                            </span>
                            {plant.zone}
                          </ListItem>
                          <ListItem>
                            <span key={plant.maturity} style={bold}>
                              Maturity:{" "}
                            </span>
                            {plant.maturity} days
                          </ListItem>
                    ...
                    <div className="buttonplanner">
                      <Button
                        style={button}
                        onClick={(e) => addGardenPlant(e, plant._id)}
                        colorScheme="orange"
                      >
                        Add to Garden
                      </Button>
                      <Button
                        style={{ backgroundColor: "#85ae5a" }}
                        onClick={(e) => addFavPlant(e, plant._id)}
                      >
                        <i className="bi bi-star search"></i>
                      </Button>
                    </div>
                  </CardBody>
                </Card>
